...
def read_file(data_dir, image_dir, mask_dir, multiclass=True, threshold=0.5, subset_size=None, crop_size=128):
    """
    ...
    for i, image_file in enumerate(image_files):
        ...
        mask_array = normalize_by_layer(mask_array)
...
if __name__ == "__main__":
    ...
    inspect_dataset(image_dataset, mask_dataset, sample_size=13)
